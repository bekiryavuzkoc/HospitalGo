...
public class HospitalLocationActivity extends AppCompatActivity {

    private static final String TAG = "GetLocationFragment";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.hospital_location_activity);
        ...
        searchHospitalImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (distanceID.getText().toString().equals("")) {
                    Toast.makeText(HospitalLocationActivity.this,"Please enter a value", Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void getLocationData() {
        ...
        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(HospitalLocationActivity.this);//create a fusedLocationProviderClient
        settingsClient = LocationServices.getSettingsClient(HospitalLocationActivity.this);  //create a settingsClient
        ...
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationAvailability(LocationAvailability locationAvailability) {
                if (locationAvailability != null) {
                    ...
                    locationAvailability.getLocationStatus();
                    locationAvailability.getWifiStatus();
                            ...
                            switch (statusCode) {
                                case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                    try {
                                        ...
                                        rae.startResolutionForResult(HospitalLocationActivity.this, 0);
    ...
    private void findHospitalsBySiteKit(int desiredRadius){
        searchService = SearchServiceFactory.create(HospitalLocationActivity.this);
        final Coordinate location2 = new Coordinate(latitude,longtitude);
        NearbySearchRequest nearbySearchRequest = new NearbySearchRequest();
        nearbySearchRequest.setLocation(location2);
        nearbySearchRequest.setQuery("Hospital");
    ...
    private void showHospitalsInMap() {
        Intent intent = new Intent(HospitalLocationActivity.this, MapActivity.class);
